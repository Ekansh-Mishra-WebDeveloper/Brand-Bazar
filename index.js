...
(function() {
  ...
  // Close menu if user taps outside the content (optional – works with overlay)
  if (mobileNav) {
    mobileNav.addEventListener('click', function(e) {
      // If the click is directly on the overlay (not its children), close menu
  ...
  // Close menu if user clicks outside the menu content (optional – since it's full screen, not needed)
